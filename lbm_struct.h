...
typedef enum lbm_cell_type_e
{
	...
	CELL_FUILD,
	/** Cellules de l'obstacle ou des bordures supérieures et inférieures. Application de réflexion. **/
	CELL_BOUNCE_BACK,
...
/********************  STRUCT  **********************/
/**
 * Tableau maintenant les informations de type pour les cellules.
**/
